...
<p align = "center">
Fig 2 - Environment logs over training steps for the QPAMDP algorithm. From left to right: Evolution of the ratio of action taken (pink is LEAP, green is RUN blue is HOP), evolution of the average reward per episode, evolution of the average number of steps per episode. The last graph allows to monitor which of the DQN (0) or the A2C (1) agent is currently training.
</p>
